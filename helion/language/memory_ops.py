...
#
# The implementation lives in the ``helion/_compiler/nki/`` subpackage
# (mirroring ``helion/_compiler/pallas/``). These two registrations are thin
# shims that delegate to ``nki.codegen``; all NKI helpers and the load/store
# bodies were moved there verbatim. Imports are lazy to avoid an import cycle
# (memory_ops is imported very early).
# ============================================================================
